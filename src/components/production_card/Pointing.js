...
const Pointing = (p) => {
  ...
  return (
    <div className={c.container}>
      <div className={c.cardContainer} onClick={e=>onClickHandler(e, "ab")} >
        <div className={c.card}>AB</div>
      </div>
      <div className={c.cardContainer} onClick={e=>onClickHandler(e, "ad")} >
        <div className={c.card}>Admin</div>
      </div>
      <div className={c.cardContainer} onClick={e=>onClickHandler(e, "ot")} >
        <div className={c.card}>over time</div>
      </div>
      <div className={c.cardContainer} onClick={e=>onClickHandler(e, "ma")} >
        <div className={c.card}>ma</div>
      </div>
      <div className={c.cardContainer} onClick={e=>onClickHandler(e, "ctp")} >
      ...
      <div className={c.cardContainer} onClick={e=>onClickHandler(e, "t")} >
        <div className={c.card}>t</div>
      </div>
      <div className={c.cardContainer} onClick={e=>onClickHandler(e, "tl")} >
        <div className={c.card}>tl</div>
      </div>
      <div className={c.cardContainer} onClick={e=>onClickHandler(e, "retard")} >
        <div className={c.card}>retard</div>
      </div>
      <div className={c.cardContainer} onClick={e=>onClickHandler(e, "other")} >
